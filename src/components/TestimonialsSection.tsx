...
const slides = [
  {
    ...
    badge: "3K+ First Month",
    badgeIcon: DollarSign,
    highlight: "30 Days",
    caption: "Her first real breakthrough — after trying everything else.",
    accent: "hsl(38,70%,55%)",
    quote: "This time it’s actually the one.",
  },
  {
    src: client2,
    alt: "Client testimonial",
    badge: "Fast Start Result",
    badgeIcon: Zap,
    highlight: "3 Weeks In",
    caption: "From skeptical… to $2K in just 3 weeks.",
    accent: "hsl(30,60%,50%)",
    quote: "Happy I finally took the step.",
  },
  {
    src: client3,
    alt: "Client testimonial",
    ...
    badgeIcon: Flame,
    highlight: "$75K in 4.5 Months",
    caption: "Proof of what’s possible with consistency.",
    accent: "hsl(25,65%,48%)",
    quote: "Never been so lit up about an opportunity.",
  },
  {
    src: client4,
    alt: "Client testimonial",
    badge: "Breakthrough Result",
    badgeIcon: TrendingUp,
    highlight: "4 Figures",
    caption: "What took months before… happened in days.",
    accent: "hsl(40,65%,52%)",
    quote: "Took me 4 months before to make the same amount.",
  },
  {
    src: client5,
    alt: "Client testimonial",
    ...
    badgeIcon: DollarSign,
    highlight: "6 months",
    caption: "When momentum compounds fast.",
    accent: "hsl(35,68%,50%)",
    quote: "I kinda lost track with all the bonuses.",
  },
  {
    src: client6,
    alt: "Client testimonial",
    badge: "New Member Win",
    badgeIcon: Star,
    highlight: "$6K Earned",
    caption: "She did it anyway — and it worked.",
    accent: "hsl(28,62%,48%)",
    quote: "My husband was absolutely against it.",
  },
  {
    src: client7,
    alt: "Client testimonial",
    badge: "Growing Fast",
    badgeIcon: TrendingUp,
    highlight: "$29K Revenue",
    caption: "Growth accelerated once they started sharing.",
    accent: "hsl(42,72%,54%)",
    quote: "Most of it happened in the past 13 weeks.",
  },
];
    ...
    >
      ...
      <div className="hidden md:block absolute top-12 right-[15%] animate-[float_6s_ease-in-out_infinite]">
        <div
          ...
          style={{
            background: "radial-gradient(circle, hsl(38,70%,55%), transparent)",
          }}
        />
      </div>
      <div className="hidden md:block absolute bottom-16 left-[10%] animate-[float_8s_ease-in-out_infinite_1s]">
        <div
          ...
          style={{
            background: "radial-gradient(circle, hsl(30,60%,50%), transparent)",
          }}
        />
      </div>
      ...
      <div className="hidden md:block absolute top-1/3 right-[8%] opacity-15">
        <Star
          className="w-8 h-8 gold-accent fill-current animate-pulse"
          style={{ animationDelay: "1s" }}
        />
      </div>
      <div className="hidden md:block absolute bottom-1/3 right-[20%] opacity-10">
        <Heart
          className="w-6 h-6 gold-accent fill-current animate-pulse"
      ...
      >
        ...
        <p className="font-body text-center text-muted-foreground max-w-xl mx-auto mb-10 md:mb-14 text-sm sm:text-base">
          These are actual messages from women who took action. No filters, no
                  ...
                  <div className="relative group">
                    <div className="relative bg-card rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-border/30">
                      ...
                      <div
                        ...
                        style={{
                          background: `linear-gradient(90deg, ${slide.accent}, hsl(38,70%,55%))`,
                        }}
                      />
